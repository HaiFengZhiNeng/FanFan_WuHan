...
public class WuHanFQActivity extends BarBaseActivity implements ILocalSoundPresenter.ILocalSoundView{
    @BindView(R.id.fq_webView)
    WebView webView;
    public static void newInstance(Activity context) {
        Intent intent = new Intent(context, WuHanFQActivity.class);
    ...
    protected int getLayoutId() {
        return R.layout.activity_wu_han_fq;
    }
...
//        webView.loadUrl("file:///android_asset/example.html");
        ...
        webView.loadUrl("http://www.mafengwo.cn/travel-scenic-spot/mafengwo/10133.html");
