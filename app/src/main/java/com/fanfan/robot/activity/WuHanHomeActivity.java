...
public class WuHanHomeActivity  extends BarBaseActivity implements ILocalSoundPresenter.ILocalSoundView{
    @BindView(R.id.home_webView)
    WebView webView;
    public static void newInstance(Activity context) {
        Intent intent = new Intent(context, WuHanHomeActivity.class);
    ...
    protected int getLayoutId() {
        return R.layout.activity_wu_han_home;
    }
