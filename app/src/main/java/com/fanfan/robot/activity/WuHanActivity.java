...
public class WuHanActivity extends BarBaseActivity implements ILocalSoundPresenter.ILocalSoundView , IChatPresenter.IChatView {
    @BindView(R.id.wh_webView)
    WebView webView;
    public static void newInstance(Activity context) {
        Intent intent = new Intent(context, WuHanActivity.class);
    ...
    protected int getLayoutId() {
        return R.layout.activity_wu_han;
    }
...
//        webView.loadUrl("file:///android_asset/example.html");
        ...
        webView.loadUrl("http://crj.wuhan.gov.cn/zhyw/bsznQueryIndex.do");
...
/*        mVrPanoramaView.resumeRendering();*/
        ...
        addSpeakAnswer("您好，这里是出入境管理网上业务办理系统，如需输入个人资料，请您注意保护个人信息安全");
    }
