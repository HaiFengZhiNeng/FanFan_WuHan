...
public class RobotInfo {
    ...
    public RobotInfo init(Context context) {
        ...
        setServer2Id(Constants.server2Id);
        setServer3Id(Constants.server3Id);
        setServer4Id(Constants.server4Id);
    ...
    private String server2Id;
    private String server3Id;
    private String server4Id;
    ...
    //第二个web客服
    public String getServer2Id() {
        return server2Id;
    }

    public void setServer2Id(String server2Id) {
        this.server2Id = server2Id;
    }

    //第三个web客服
    public String getServer3Id() {
        return server3Id;
    }

    public void setServer3Id(String server3Id) {
        this.server3Id = server3Id;
    }

    //第四个web客服
    public String getServer4Id() {
        return server4Id;
    }

    public void setServer4Id(String server4Id) {
        this.server4Id = server4Id;
    }
...
//    private boolean isSetingPwd;
//
//    public void setSetingPwd(boolean isSet){
//        this.isSetingPwd = isSet;
//        PreferencesUtils.putBoolean(NovelApp.getInstance().getApplicationContext(), Constants.IS_SET_PWD, isSet);
//    }
//
//    public boolean isSetingPwd(){
//        return isSetingPwd;
//    }


//    public String getSettingPwd() {
//        return PreferencesUtils.getString(NovelApp.getInstance().getApplicationContext(), Constants.SET_PWD, "");
//    }
//
//    public void setSettingPwd(String settingPwd) {
//        PreferencesUtils.putString(NovelApp.getInstance().getApplicationContext(), Constants.SET_PWD, settingPwd);
//        setSetingPwd(true);
//    }
}
