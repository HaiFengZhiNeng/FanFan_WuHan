...
public class LogoutStrategy extends Strategy implements SpecialStrategy {

    @Override
    public SpecialType specialLocal(String speakTxt) {
        return txtInTxt(speakTxt, R.string.Logout) ? SpecialType.Logout : SpecialType.NoSpecial;
    }
}
