...
public class MediaSessionManager {
    ...
    public MediaSessionManager(Context context, PlayService playService) {
        mContext = context;
    ...
    public void updateMetaData(Music music) {
        ...
        MediaMetadataCompat.Builder metaData = new MediaMetadataCompat.Builder()
                ...
                .putBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART,
                        music.getAlbumId() == -1 ? MusicUtils.createAlbumArt(music.getPath()) : MusicUtils.loadCoverFromMediaStore(mContext, music));
